...
- :file_folder: `05-data-access` -> small application that demonstrates database access with MySQL.
- :file_folder: `06-go-netcalc` -> small cli application to calculate IPv4 network information from a CIDR input.
